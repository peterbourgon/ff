...
func TestParse(t *testing.T) {
	...
	testcases := fftest.TestCases{
		...
		},
		{
			...
			Options:     []ff.Option{ff.WithEnvVarPrefix("TEST_PARSE"), ff.WithEnvVarShortNames()},
		...
		},
		{
			...
			Options:     []ff.Option{ff.WithEnvVarPrefix("TEST_PARSE"), ff.WithEnvVarShortNames(), ff.WithEnvVarSplit(",")},
		...
		},
		{
			...
			Options:     []ff.Option{ff.WithEnvVarPrefix("TEST_PARSE"), ff.WithEnvVarShortNames(), ff.WithEnvVarSplit("xx")},
