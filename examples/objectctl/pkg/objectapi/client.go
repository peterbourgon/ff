...
func (s *mockServer) delete(token, key string, force bool) (existed bool, _ error) {
	if token != s.token {
...
var defaultObjects = map[string]Object{
	"aardvark": {
		Key:    "aardvark",
		Value:  "A nocturnal burrowing mammal with long ears, a tubular snout, and a long extensible tongue.",
		Access: mustParseTime(time.RFC3339, "2019-03-15T17:18:19Z"),
	},
	"apple": {
		Key:    "apple",
